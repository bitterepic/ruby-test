...
# pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive/parser.rb:1
module JSONAPI; end
...
#
# pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive/parser.rb:2
class JSONAPI::IncludeDirective
  # @return [IncludeDirective] a new instance of IncludeDirective
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive.rb:16
  def initialize(include_args, options = T.unsafe(nil)); end

  # @param key [Symbol, String]
  # @return [IncludeDirective, nil]
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive.rb:39
  def [](key); end

  # @param key [Symbol, String]
  # @return [Boolean]
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive.rb:27
  def key?(key); end

  # @return [Array<Symbol>]
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive.rb:33
  def keys; end

  # @return [Hash{Symbol => Hash}]
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive.rb:51
  def to_hash; end

  # @return [String]
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive.rb:58
  def to_string; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive.rb:78
  def valid?(key); end

  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive.rb:82
  def valid_json_key_name_regex; end
end

# pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive.rb:74
...
# inputs.
#
# pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive/parser.rb:5
module JSONAPI::IncludeDirective::Parser
  private

  # @api private
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive/parser.rb:54
  def deep_merge!(src, ext); end

  # @api private
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive/parser.rb:47
  def parse_array(include_array); end

  # @api private
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive/parser.rb:40
  def parse_hash(include_hash); end

  # @api private
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive/parser.rb:9
  def parse_include_args(include_args); end

  # @api private
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive/parser.rb:33
  def parse_path_string(include_path); end

  # @api private
  #
  # pkg:gem/jsonapi-renderer#lib/jsonapi/include_directive/parser.rb:25

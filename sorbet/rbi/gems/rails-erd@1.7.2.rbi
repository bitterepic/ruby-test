...
#
# pkg:gem/rails-erd#lib/rails_erd/railtie.rb:1
module RailsERD
  class << self
    # pkg:gem/rails-erd#lib/rails_erd.rb:37
    def default_options; end

    # pkg:gem/rails-erd#lib/rails_erd.rb:64
    def load_tasks; end

    # pkg:gem/rails-erd#lib/rails_erd.rb:62
    def loaded_tasks; end

    # pkg:gem/rails-erd#lib/rails_erd.rb:61
    ...
    #
    # pkg:gem/rails-erd#lib/rails_erd.rb:35
    def options; end
...
# pkg:gem/rails-erd#lib/rails_erd/config.rb:4
class RailsERD::Config
  # @return [Config] a new instance of Config
  #
  # pkg:gem/rails-erd#lib/rails_erd/config.rb:14
  def initialize; end

  # pkg:gem/rails-erd#lib/rails_erd/config.rb:18
  def load(extra_config_file = T.unsafe(nil)); end

  # Returns the value of attribute options.
  #
  # pkg:gem/rails-erd#lib/rails_erd/config.rb:8
  def options; end

  private

  # pkg:gem/rails-erd#lib/rails_erd/config.rb:43
  def load_file(path); end

  # pkg:gem/rails-erd#lib/rails_erd/config.rb:52
  def normalize_value(key, value); end

  class << self
    # pkg:gem/rails-erd#lib/rails_erd/config.rb:29
    def font_names_based_on_os; end

    # pkg:gem/rails-erd#lib/rails_erd/config.rb:10
    def load(extra_config_file = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # pkg:gem/rails-erd#lib/rails_erd/config.rb:95
    def use_os_x_fonts?; end
  end
end

# pkg:gem/rails-erd#lib/rails_erd/config.rb:6
RailsERD::Config::CURRENT_CONFIG_FILE = T.let(T.unsafe(nil), String)

# pkg:gem/rails-erd#lib/rails_erd/config.rb:5
RailsERD::Config::USER_WIDE_CONFIG_FILE = T.let(T.unsafe(nil), String)

# @private :nodoc:
#
# pkg:gem/rails-erd#lib/rails_erd.rb:72
module RailsERD::Inspectable
  # pkg:gem/rails-erd#lib/rails_erd.rb:73
...
#
# pkg:gem/rails-erd#lib/rails_erd/railtie.rb:5

...
class Subscription
  ...
  module CommonRelationMethods
    ...
    sig { params(args: T.untyped).returns(T::Array[::Subscription]) }
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[T::Array[::Subscription]])
    end
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Subscription` class because it declared `has_many :transactions`.
